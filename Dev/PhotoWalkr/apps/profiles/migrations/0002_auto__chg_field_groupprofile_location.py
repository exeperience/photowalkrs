...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupProfile.location'
        db.alter_column('profiles_groupprofile', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'GroupProfile.location'
        raise RuntimeError("Cannot reverse this migration. 'GroupProfile.location' and its values cannot be restored.")
    ...
    models = {
        ...
        'photos.photoinfo': {
            ...
            'taken': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 25, 3, 8, 16, 459178)', 'null': 'True', 'blank': 'True'})
        },
        'photos.stats': {
